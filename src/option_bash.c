...
int option_entry(int argc, char* argv[])
{
    ...
    const struct option long_options[] = {
        {"help", 0, NULL, 'h'}, {"output", 1, NULL, 'o'}, {"verbose", 0, NULL, 'v'}, {NULL, 0, NULL, 0}
    ...
    */
    if (output_filename != NULL)
    {
        ...
        time_t t = time(NULL);
        fprintf(file, "Estoy escribiendo en %s usando '-o' jeje, y hoy es: %s\n", output_filename, ctime(&t));
        fclose(file);
    }
    return 0;
}
